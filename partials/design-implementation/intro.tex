...
\noindent{}The resulting mapping between \silvia{??...} is shown in figure \ref{fig:functions-workflow}.
...
\silvia{necessary? The function groups are exempted from this rule as they only exist to give structure to the figure.}
...
\begin{figure}[!htb]
	...
	\caption{
		...
		Vertical columns represent different function groups, colours are used for different user roles, and arrows indicate sequence of actions. \silvia{i dont understand this, and think this is not necessary to understand the figure: Each of the functions belong to a certain actor (human or system), which are identified by the colour of the actor block (light shade) and the corresponding colour of the function block (dark shade).}
