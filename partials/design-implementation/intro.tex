...
%Need to be more explicit about the system and the prototype - the implementation does not cover the complete system, but you did consider a lot more than the actual prototype. 
%I suggest to stick to prototype whenever you are talking about the system you implemented, just to stress that this is a small piece of a much larger scope
