...
The front-end is based on the AngularJS\footnote{https://angularjs.org/} framework and coded with Coffeescript\footnote{http://coffeescript.org/} which is compiled into JavaScript.
