...
To describe the path data has taken, W3C \silvia{explain, ref} has made a standard described in the PROV Model Primer \cite{dsp8gil}.
...
\silvia{this paragraph is good, but seems repetitive to stuff that were mentioned before} There are many applications of provenance in security, different levels can be supplied by mixing computerised surveillance with human insight.
