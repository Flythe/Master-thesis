...
%\silvia{i think this is not necessary: Data is not the scope of this study, however the problems above have caused significant delays and modifications to the initial study goals.}
...
Bringing the \ivfsystem{} concept into a brainstorm session proved to be quite difficult. Without experience with the data, it was too abstract for the users to form useful ideas.
...
\silvia{suggestion: add references to the sections where the various topics mentioned above are further presented}
