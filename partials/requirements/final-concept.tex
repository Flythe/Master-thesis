...
While data handling functions like searching, security restriction, auditing, or annotating with metadata are important in this system, \silvia{??there are more side effects of research that have to be taken into account??}.
