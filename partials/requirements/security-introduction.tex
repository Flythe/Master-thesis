...
Security is an integral and important part of the \project{} gateway because it deals with linked data that potentially can be used to re-identify individuals and, in this case, also organisation (clinics)
...
\silvia{part of this general big data part should be merged into intro. then here you just recap the main point and go on with the }
